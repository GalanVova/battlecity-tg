...
SceneManager.prototype.toTankPowerSelectScene = function () {
  this._eventManager.removeAllSubscribers();
  this._scene = new TankPowerSelectScene(this);
};
...
SceneManager.prototype.toMultiplayerLobby = function (ws) {
  this._eventManager.removeAllSubscribers();
  this._scene = new MultiplayerLobby(this, ws);
};
